\doxysection{openphase\+::OPObject Class Reference}
\hypertarget{classopenphase_1_1OPObject}{}\label{classopenphase_1_1OPObject}\index{openphase::OPObject@{openphase::OPObject}}


{\ttfamily \#include "{}OPObject.\+h"{}}

Inheritance diagram for openphase\+::OPObject\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=12.000000cm]{d6/dcd/classopenphase_1_1OPObject}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
virtual \mbox{\hyperlink{classopenphase_1_1OPObject_a07a6430ccf276b32cd70e57c53d372d5}{\texorpdfstring{$\sim$}{\string~}\+OPObject}} (void)
\item 
...
Definition at line \mbox{\hyperlink{OPObject_8h_source_l00049}{49}} of file \mbox{\hyperlink{OPObject_8h_source}{OPObject.\+h}}.



\doxysubsection{Constructor \& Destructor Documentation}
\Hypertarget{classopenphase_1_1OPObject_a07a6430ccf276b32cd70e57c53d372d5}\label{classopenphase_1_1OPObject_a07a6430ccf276b32cd70e57c53d372d5} 
\index{openphase::OPObject@{openphase::OPObject}!````~OPObject@{\texorpdfstring{$\sim$}{\string~}OPObject}}
\index{````~OPObject@{\texorpdfstring{$\sim$}{\string~}OPObject}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{\texorpdfstring{$\sim$}{\string~}OPObject()}{\string~OPObject()}}
{\footnotesize\ttfamily openphase\+::\+OPObject\+::\texorpdfstring{$\sim$}{\string~}\+OPObject (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}



Definition at line \mbox{\hyperlink{OPObject_8cpp_source_l00032}{32}} of file \mbox{\hyperlink{OPObject_8cpp_source}{OPObject.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00033\ \{}
\DoxyCodeLine{00034\ \ \ \ \ \textcolor{keywordflow}{if}(\mbox{\hyperlink{classopenphase_1_1OPObject_a9006e8f49762d851b52708b363ba14f2}{thisclassname}}.size()\ !=\ 0)}
\DoxyCodeLine{00035\ \ \ \ \ \{}
\DoxyCodeLine{00036\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classopenphase_1_1ConsoleOutput_ae2753bb70e817b1bdd5ae2b99adf6e0f}{ConsoleOutput::WriteStandard}}(this-\/>\mbox{\hyperlink{classopenphase_1_1OPObject_a9006e8f49762d851b52708b363ba14f2}{thisclassname}},\ \textcolor{stringliteral}{"{}Exited\ normally"{}});}
\DoxyCodeLine{00037\ \ \ \ \ \}}
\DoxyCodeLine{00038\ \textcolor{preprocessor}{\#ifdef\ DEBUG}}
\DoxyCodeLine{00039\ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00040\ \ \ \ \ \{}
\DoxyCodeLine{00041\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classopenphase_1_1ConsoleOutput_a3d39f6f01e37b75d360090aa734bc1bd}{ConsoleOutput::WriteWarning}}(\textcolor{stringliteral}{"{}Uninitialized\ object\ exited\ normally"{}},}
\DoxyCodeLine{00042\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}OPObject"{}},\textcolor{stringliteral}{"{}\string~OPObject"{}});}
\DoxyCodeLine{00043\ \ \ \ \ \}}
...
\index{openphase::OPObject@{openphase::OPObject}!Advect@{Advect}}
\index{Advect@{Advect}!openphase::OPObject@{openphase::OPObject}}
...
\index{openphase::OPObject@{openphase::OPObject}!FindObjects@{FindObjects}}
\index{FindObjects@{FindObjects}!openphase::OPObject@{openphase::OPObject}}
...
\index{openphase::OPObject@{openphase::OPObject}!Initialize@{Initialize}}
\index{Initialize@{Initialize}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{Initialize()}{Initialize()}}
{\footnotesize\ttfamily virtual void openphase\+::\+OPObject\+::\+Initialize (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classopenphase_1_1Settings}{Settings}} \&}]{loc\+Settings,  }\item[{std\+::string}]{Object\+Name\+Suffix = {\ttfamily "{}"{}} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{openphase::OPObject@{openphase::OPObject}!MoveFrame@{MoveFrame}}
\index{MoveFrame@{MoveFrame}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{MoveFrame()}{MoveFrame()}}
{\footnotesize\ttfamily virtual void openphase\+::\+OPObject\+::\+Move\+Frame (\begin{DoxyParamCaption}\item[{const int}]{dx,  }\item[{const int}]{dy,  }\item[{const int}]{dz,  }\item[{const \mbox{\hyperlink{classopenphase_1_1BoundaryConditions}{Boundary\+Conditions}} \&}]{BC }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{openphase::OPObject@{openphase::OPObject}!Read@{Read}}
\index{Read@{Read}!openphase::OPObject@{openphase::OPObject}}
...
\index{openphase::OPObject@{openphase::OPObject}!ReadInput@{ReadInput}}
\index{ReadInput@{ReadInput}!openphase::OPObject@{openphase::OPObject}}
...
\index{openphase::OPObject@{openphase::OPObject}!Remesh@{Remesh}}
\index{Remesh@{Remesh}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{Remesh()}{Remesh()}}
{\footnotesize\ttfamily virtual void openphase\+::\+OPObject\+::\+Remesh (\begin{DoxyParamCaption}\item[{int}]{new\+Nx,  }\item[{int}]{new\+Ny,  }\item[{int}]{new\+Nz,  }\item[{const \mbox{\hyperlink{classopenphase_1_1BoundaryConditions}{Boundary\+Conditions}} \&}]{BC }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{openphase::OPObject@{openphase::OPObject}!SetBoundaryConditions@{SetBoundaryConditions}}
\index{SetBoundaryConditions@{SetBoundaryConditions}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{SetBoundaryConditions()}{SetBoundaryConditions()}}
{\footnotesize\ttfamily virtual void openphase\+::\+OPObject\+::\+Set\+Boundary\+Conditions (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classopenphase_1_1BoundaryConditions}{Boundary\+Conditions}} \&}]{BC }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{openphase::OPObject@{openphase::OPObject}!Write@{Write}}
\index{Write@{Write}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{Write()}{Write()}}
{\footnotesize\ttfamily virtual bool openphase\+::\+OPObject\+::\+Write (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classopenphase_1_1Settings}{Settings}} \&}]{loc\+Settings,  }\item[{const int}]{t\+Step }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\index{openphase::OPObject@{openphase::OPObject}!advectable@{advectable}}
\index{advectable@{advectable}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{advectable}{advectable}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::advectable = false}
...
\index{openphase::OPObject@{openphase::OPObject}!boundary\_conditions@{boundary\_conditions}}
\index{boundary\_conditions@{boundary\_conditions}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{boundary\_conditions}{boundary\_conditions}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::boundary\+\_\+conditions = false}
...
\index{openphase::OPObject@{openphase::OPObject}!initialized@{initialized}}
\index{initialized@{initialized}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{initialized}{initialized}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::initialized = false}
...
\index{openphase::OPObject@{openphase::OPObject}!input\_read@{input\_read}}
\index{input\_read@{input\_read}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{input\_read}{input\_read}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::input\+\_\+read = false}
...
\index{openphase::OPObject@{openphase::OPObject}!readable@{readable}}
\index{readable@{readable}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{readable}{readable}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::readable = false}
...
\index{openphase::OPObject@{openphase::OPObject}!remeshable@{remeshable}}
\index{remeshable@{remeshable}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{remeshable}{remeshable}}
{\footnotesize\ttfamily bool openphase\+::\+OPObject\+::remeshable = false}
...
\index{openphase::OPObject@{openphase::OPObject}!thisclassname@{thisclassname}}
\index{thisclassname@{thisclassname}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{thisclassname}{thisclassname}}
{\footnotesize\ttfamily std\+::string openphase\+::\+OPObject\+::thisclassname}
...
\index{openphase::OPObject@{openphase::OPObject}!thisobjectname@{thisobjectname}}
\index{thisobjectname@{thisobjectname}!openphase::OPObject@{openphase::OPObject}}
\doxysubsubsection{\texorpdfstring{thisobjectname}{thisobjectname}}
{\footnotesize\ttfamily std\+::string openphase\+::\+OPObject\+::thisobjectname}
...
\item 
\mbox{\hyperlink{OPObject_8h}{OPObject.\+h}}\item 
\mbox{\hyperlink{OPObject_8cpp}{OPObject.\+cpp}}\end{DoxyCompactItemize}
